        ...
        >
          ...
          <a href="#" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
            <svg width="32" height="37" viewBox="0 0 130.35 151.82" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path className="ls1" d="M98,106.43l50.81,38.46-74,7.41S124.79,175,125.55,175s47.75,10.47,47.75,10.47l-22.47-40.6,28.6-38.8L139.6,230.94l-10.47-51.07L98.05,107.92l-1.35-3.11,59.38,26.86L196,149.74,127.85,176l-35.49,21.7,23.12-49.46,10.11-21.56,14.26-37.49,33.45,96.26" transform="tranvaporGraphite(-69.9 -83.76)"/>
            ...
            <div>
              <div style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: '1.1rem', letterSpacing: '-0.04em', color: 'var(--vaporGhost)' }}>
                Sidere<span style={{ color: 'var(--vaporPlasma)' }}>AI</span>
              </div>
              <div style={{ fontFamily: 'Fira Code, monospace', fontSize: '0.55rem', letterSpacing: '0.14em', color: 'rgba(250,248,245,0.45)' }}>
                INGENIERÍA NEURAL
              </div>
            </div>
          </a>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              style={{ background: 'transparent', border: 'none', color: 'var(--vaporGhost)', cursor: 'pointer' }}
            >
              <Menu size={22} />
            </button>
          </div>
