...
import { ExternalLink, Globe, QrCode, ScanLine, Building2, Cake } from 'lucide-react'
...
const projects = [
  ...
  },
  {
    ...
    description: 'Herramienta web de acceso libre para generar, personalizar y escanear códigos QR al instante. Cero instalación, funciona directamente desde el navegador.',
  ...
  },
  {
    ...
    description: 'Presencia digital premium para un hotel boutique. Galería inmersiva, sistema de reservas integrado, y diseño que captura la experiencia única del establecimiento.',
  ...
  },
  {
    ...
    description: 'Sitio web elegante para una pastelería artesanal. Catálogo de productos visual, pedidos vía WhatsApp y diseño que refleja la artesanía y calidad de sus creaciones.',
    ...
    >
      ...
      <div style={{ padding: '1.5rem 1.75rem 2rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem' }}>
          <div>
            <h3 style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: '1.3rem', letterSpacing: '-0.03em', color: 'var(--vaporGhost)', marginBottom: '0.25rem' }}>
              {project.title}
            </h3>
        ...
        {/* Description */}
        <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '0.875rem', lineHeight: 1.7, color: 'rgba(250,248,245,0.5)', fontWeight: 300, marginTop: '0.85rem', marginBottom: '1.25rem' }}>
          {project.description}
        </p>
...
export default function Portfolio() {
  ...
  return (
    <section ref={sectionRef} id="portafolio" className="section-padding" style={{ background: 'var(--vaporGraphite)', backgroundImage: 'radial-gradient(ellipse at top, rgba(201,168,76,0.04) 0%, transparent 60%)' }}>
        ...
        <div style={{ marginBottom: '3.5rem', display: 'flex', flexWrap: 'wrap', gap: '1rem', alignItems: 'flex-end', justifyContent: 'space-between' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 'clamp(2rem, 4vw, 3rem)', letterSpacing: '-0.04em', color: 'var(--vaporGhost)', lineHeight: 1.1 }}>
              Soluciones que{' '}
              <span className="serif-italic" style={{ color: 'var(--vaporPlasma)' }}>funcionan</span>
            </h2>
            <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '0.95rem', color: 'rgba(250,248,245,0.5)', marginTop: '0.75rem', maxWidth: '420px', lineHeight: 1.7, fontWeight: 300 }}>
