        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'start' }}>
          ...
          <div className="meth-title">
            ...
            <h2 style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 'clamp(2rem, 4vw, 3rem)', letterSpacing: '-0.04em', color: 'var(--vaporGhost)', lineHeight: 1.1 }}>
              Del caos a la{' '}
              <span className="serif-italic" style={{ color: 'var(--vaporPlasma)' }}>precisión</span>
            </h2>
            <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '0.95rem', color: 'rgba(250,248,245,0.5)', marginTop: '1.25rem', lineHeight: 1.8, fontWeight: 300 }}>
            ...
            <div
              ...
              style={{ marginTop: '2.5rem', padding: '1.5rem', borderLeft: '2px solid var(--vaporPlasma)' }}
            >
              <div style={{ fontFamily: 'Fira Code, monospace', fontSize: '0.65rem', letterSpacing: '0.15em', color: 'rgba(250,248,245,0.4)', marginBottom: '0.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--vaporPlasma)', marginBottom: '0.4rem' }}>Modelos propietarios</div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--vaporPlasma)', marginBottom: '0.4rem' }}>Soberanía total de datos</div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--vaporPlasma)' }}>Independencia operativa</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', paddingTop: '0.5rem' }}>
            {steps.map((step, i) => (
              ...
              >
                ...
                <h3 style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: '1.1rem', letterSpacing: '-0.025em', color: 'var(--vaporGhost)', marginBottom: '0.5rem' }}>
                  {step.title}
                </h3>
                <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '0.875rem', lineHeight: 1.75, color: 'rgba(250,248,245,0.5)', fontWeight: 300 }}>
                  {step.description}
                </p>
              </div>
            ))}
