...
export default function Insights() {
  ...
  return (
    <section ref={sectionRef} id="insights" className="section-padding" style={{ background: 'var(--slate)' }}>
      <div className="container-wide">
        ...
        <div style={{ marginBottom: '3rem' }}>
          ...
          <h2 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: 'clamp(2rem, 4vw, 3rem)', letterSpacing: '-0.04em', color: 'var(--ivory)', lineHeight: 1.1 }}>
            Pensamiento{' '}
            <span className="serif-italic" style={{ color: 'var(--champagne)' }}>crítico</span>
          </h2>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
          {articles.map((article, i) => (
            ...
            >
              ...
              {/* Title */}
              <h3 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '1.1rem', letterSpacing: '-0.025em', color: 'var(--ivory)', lineHeight: 1.3 }}>
                {article.title}
              </h3>

              {/* Excerpt */}
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.87rem', lineHeight: 1.7, color: 'rgba(250,248,245,0.5)', fontWeight: 300 }}>
                {article.excerpt}
              </p>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto', paddingTop: '1rem', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.65rem', letterSpacing: '0.1em', color: 'rgba(250,248,245,0.3)' }}>
                  {article.date}
                </span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', color: 'var(--champagne)', fontSize: '0.78rem', fontWeight: 600 }}>
