...
export default function Footer() {
  ...
  return (
    <footer
      id="contacto"
      style={{
        background: 'var(--vaporBg-deep, #08080C)',
        borderTop: 'none',
        position: 'relative',
        overflow: 'hidden',
      }}
    >
      ...
      <div style={{
        ...
        height: '3px',
        background: 'linear-gradient(90deg, transparent, var(--vaporPlasma), var(--vaporPlasma), var(--vaporPlasma), transparent)',
      }} />
      ...
      >
        <div className="container-wide" style={{ maxWidth: 720 }}>
          <div style={{ fontFamily: 'Fira Code, monospace', fontSize: '0.68rem', letterSpacing: '0.18em', color: 'var(--vaporPlasma)', marginBottom: '1rem' }}>
            — INICIEMOS UNA CONVERSACIÓN
          </div>
          <h2 style={{
            fontFamily: 'Sora, sans-serif', fontWeight: 700,
            fontSize: 'clamp(2rem, 5vw, 3.5rem)',
            letterSpacing: '-0.04em', color: 'var(--vaporGhost)', lineHeight: 1.05, marginBottom: '1.25rem',
          }}>
            ¿Listo para construir algo{' '}
            <span className="serif-italic" style={{ color: 'var(--vaporPlasma)' }}>extraordinario</span>?
          </h2>
          <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '1rem', color: 'rgba(250,248,245,0.5)', lineHeight: 1.75, marginBottom: '2.5rem', fontWeight: 300 }}>
      ...
      <div className="container-wide" style={{ padding: '3rem 1.5rem 2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2.5rem', marginBottom: '2.5rem' }}>
          ...
          {/* Brand */}
          <div>
            <div style={{ fontFamily: 'Sora, sans-serif', fontWeight: 800, fontSize: '1.2rem', letterSpacing: '-0.04em', color: 'var(--vaporGhost)', marginBottom: '0.5rem' }}>
              Sidere<span style={{ color: 'var(--vaporPlasma)' }}>AI</span>
            </div>
            <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '0.82rem', color: 'rgba(250,248,245,0.4)', lineHeight: 1.7, fontWeight: 300 }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1.25rem' }}>
              <a href="https://linkedin.com/company/sidereai" target="_blank" rel="noopener noreferrer"
                ...
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(201,168,76,0.15)'; e.currentTarget.style.color = 'var(--vaporPlasma)' }}
          ...
          {/* Navigation */}
          <div>
            <div style={{ fontFamily: 'Fira Code, monospace', fontSize: '0.65rem', letterSpacing: '0.15em', color: 'rgba(250,248,245,0.35)', marginBottom: '1rem' }}>
              NAVEGACIÓN
            </div>
            {[
              ...
              <div key={link.href} style={{ marginBottom: '0.5rem' }}>
                <a href={link.href} style={{ fontFamily: 'Sora, sans-serif', fontSize: '0.875rem', color: 'rgba(250,248,245,0.5)', textDecoration: 'none', transition: 'color 0.25s' }}
                  onMouseEnter={e => e.target.style.color = 'var(--vaporPlasma)'}
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
              <a href="mailto:solutions@sidereai.com" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'rgba(250,248,245,0.5)', textDecoration: 'none', fontSize: '0.875rem', transition: 'color 0.25s' }}
                onMouseEnter={e => e.currentTarget.style.color = 'var(--vaporPlasma)'}
        ...
        <div style={{
          ...
          <p style={{ fontFamily: 'Fira Code, monospace', fontSize: '0.65rem', letterSpacing: '0.1em', color: 'rgba(250,248,245,0.25)' }}>
            © {year} Sidere AI. Todos los derechos reservados.
          </p>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <div className="status-dot" />
            <span style={{ fontFamily: 'Fira Code, monospace', fontSize: '0.62rem', letterSpacing: '0.12em', color: 'rgba(34,197,94,0.7)' }}>
